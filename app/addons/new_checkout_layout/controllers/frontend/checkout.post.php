...
//    $cart['user_data']['b_city'] = $cart['user_data']['b_city_descr'];
////    $cart['user_data']['b_country'] = $cart['user_data']['b_country_descr'];
//    $cart['user_data']['b_state'] = $cart['user_data']['b_state_descr'];
//    $cart['user_data']['b_county'] = $cart['user_data']['b_district_descr'];

//    $cart['user_data']['s_county'] = $cart['user_data']['s_district_descr'];
//    $cart['user_data']['s_country'] = $cart['user_data']['s_state_descr'];
//    $cart['user_data']['s_city'] = $cart['user_data']['s_city_descr'];
//    $cart['user_data']['s_state_descr'] = $cart['user_data']['s_state'];
    ...
    fn_set_hook('checkout_select_default_payment_method', $cart, $payment_methods, $completed_steps, $auth);
