...
namespace Tygh\Addons\Sc_Single_Notice\Notifications\DataProviders;
...
class RequestCreatedDataProvider extends BaseDataProvider
{
    ...
    public function __construct(array $data,array $currencies = null, $is_mve = null)
    {
        ...
        $this->sc_single_notice = $data['sc_single_notice_data'];

        $data['order_info'] = $this->sc_single_notice;
		
		if(!empty($_REQUEST['qqq'])){
			
			fn_print_r('ho ho hoh o');
			fn_print_r($data);
		}
