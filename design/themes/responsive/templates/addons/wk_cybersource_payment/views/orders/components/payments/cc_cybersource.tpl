...
<script type="text/javascript">
 ...
 $('#place_order_tab1').on('click',function(evt){
        var yyyy = $("#credit_card_year_").val();
        console.log(yyyy);    
         if(yyyy.length != 4){
            $.ceNotification('show', {
            type: 'E',
