...
{/if}
    ...
    <div class="ty-menu ty-menu-vertical ty-menu-vertical__dropdown sd-amazon-menu sd-menu-vert sd-menu-line sd-menu-horizontal {if $block.properties.open_menu == 'click'}click{/if}">
        <ul id="vmenu_{$block.block_id}" class="ty-menu__items cm-responsive-menu{if $block.properties.right_to_left_orientation =="Y"} rtl{/if}">
            ...
            <div class="sd-menu__dropdown-box">
                {foreach from=$items item="item1" name="item1"}
                    ...
                    {/if}
                    <li class="ty-menu__item{if !$item1.$childs} ty-menu__item-nodrop{else} cm-menu-item-responsive{/if}{if $item1.active || $item1|fn_check_is_active_menu_item:$block.type} ty-menu__item-active{/if}{if $item1.class} {$item1.class}{/if}{if $block.properties.open_menu == 'click'} click{/if}">
                        {if $item1.$childs}
                        ...
                        <a {if $item1_url} href="{$item1_url}"{/if} class="ty-menu__item-link {if $block.properties.open_menu == 'click'}click{/if}">
