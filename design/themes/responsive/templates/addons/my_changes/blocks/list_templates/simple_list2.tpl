    ...
    <div class="ty-simple-list clearfix">
        ...
        {$smarty.capture.$form_open nofilter}
            ...
            <div class="row100">
                ...
                <div class="company_name">{assign var="product_features" value="product_features_`$obj_id`"}{$smarty.capture.$product_features nofilter}</div>
            {/if}
            
                <div class="product_code">{$product.product_code}</div>
            </div>
            {assign var="name" value="name_$obj_id"}<bdi>{$product.product nofilter}</bdi>
