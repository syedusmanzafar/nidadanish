...
<table class="ty-table ty-orders-search">
    ...
    {foreach from=$orders item="o"}
        <tr>
            ...
            <td style="width: 25%;" class="ty-orders-search__item ty-orders-search__item--actions">
                ...
                {include file="buttons/button.tpl"
                        ...
                        but_title=__("rma_return")
                        but_text=__("rma_return")
                        but_href="rma.create_return?order_id=`$o.order_id`"}
            </td>
        </tr>
    {foreachelse}
