...
$(document).ready(function(){
  $("#menu_open").click(function(){
    $(".mobile_header_grid_menu").toggleClass("open");
  });
...
<script>
$(document).ready(function(){
  $("#wp_floating_button").click(function(){
	$(this).toggleClass("wp_open");
    $("#wp_floating_content").fadeToggle();
  });
});
</script>
...
<script>
$(document).ready(function(){
  $("#tygh_container #filter_btn_open").click(function(){
    $("#tygh_container .search_grid_left").toggleClass("open");
  });
});
</script>
