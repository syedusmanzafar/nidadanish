    ...
    {foreach from=$items item="product" name="for_products"}
        ...
        <div class="ty-scroller-list__item">
            ...
            <div class="ty-scroller-list__img-block">
                {include file="common/image.tpl" assign="object_img" images=$product.main_pair image_width=300 image_height=450 no_ids=true lazy_load=true}
                ...
                {strip}
                    {include file="blocks/list_templates/simple_list.tpl" product=$product show_name=true show_name=true show_sku=true show_features=true show_descr=true show_old_price=true show_price=true show_list_discount=true show_product_labels=true show_discount_label=true show_shipping_label=true show_product_amount=true show_product_options=true show_qty=true min_qty=true show_edp=true show_add_to_cart=true show_list_buttons=true}
                {/strip}
...
{include file="common/product_scroller_init.tpl" prev_selector="#owl_prev_`$obj_prefix`" next_selector="#owl_next_`$obj_prefix`"}
