{if $product}
    ...
    <div class="ty-simple-list ty-simple-new clearfix">
        {assign var="form_open" value="form_open_`$obj_id`"}
        {$smarty.capture.$form_open nofilter}
            {if $item_number == "Y"}<strong>{$smarty.foreach.products.iteration}.&nbsp;</strong>
            ...
            {include file="common/product_data.tpl" product=$product but_text=__("buy")}
            ...
            {if $show_add_to_cart}
                <div class="ty-simple-list__buttons">
					...
					{assign var="add_to_cart" value="add_to_cart_fast_`$obj_id`"}
                    {$smarty.capture.$add_to_cart nofilter}
