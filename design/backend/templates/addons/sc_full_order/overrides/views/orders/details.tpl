                ...
                <div class="row-fluid">
                    <div class="span8">
                        ...
                        {if $order_info.child_order_details_info}
                            {foreach from=$order_info.child_order_details_info item="order_infoc" key="order_id"}
                                {include file="addons/sc_full_order/components/order_table.tpl" is_single=false cp_show_company=true order_info=$order_infoc}
                            {/foreach}
                        {else}
                            {include file="addons/sc_full_order/components/order_table.tpl" is_single=true order_info=$order_info}
                        {/if}
                                        ...
                                        <table class="pull-right">
                                            ...
                                            {if $order_info.display_shipping_cost|floatval}
                                                {if $order_info.child_order_details_info}
                                                    ...
                                                    {foreach from=$order_info.child_order_details_info item="subitems"}
                                                        <tr>
                                                            <td class="statistic-label">-&nbsp;{$subitems.company_id|fn_get_company_name}</td>
                    ...
                    <div class="span4">
                        <div class="well orders-right-pane form-horizontal">
                            ...
                            {/if}
                        <div class="control-group{if !$order_info.child_order_details_info} shift-top{/if}">
                                ...
                                {foreach from=$order_info.shipping item="shipping" key="shipping_id" name="f_shipp"}
                                    ...
                                    <div class="clearfix">
                                        {if $shipping.need_shipment}
                                            ...
                                            {/if}
                                            <div class="clearfix">
                                                {if "shipments.add"|fn_check_view_permissions  && !$order_info.child_order_details_info}  {*cp lemuria*}
                                    ...
                                    {if $group.all_free_shipping}
                                        <div class="clearfix">
                                            {if $order_info.need_shipping}
                                                {if "shipments.add"|fn_check_view_permissions  && !$order_info.child_order_details_info}
                                                    <div class="clearfix">
