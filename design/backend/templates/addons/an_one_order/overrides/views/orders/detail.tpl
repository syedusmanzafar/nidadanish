34343434{if $order_info.shipping}
                        ...
                        <div class="table-responsive-wrapper">
                            <table width="100%" class="table table-middle table--relative table-responsive">
                                ...
                                <tr>
                                    ...
                                    {if $auth.user_type != "V" && $order_info.is_parent_order == "Y"}
                                    <th width="10%" class="right">&nbsp;{__("an_one_order_suborder")}</th>
                                    {/if}
                                </tr>
                                </thead>
                                ...
                                {foreach from=$order_info.products item="oi" key="key"}
                                    ...
                                    {if !$oi.extra.parent}
                                        <tr>
                                            ...
                                            {if $auth.user_type != "V" && $order_info.is_parent_order == "Y"}
                                            <td class="right" data-th="{__("an_one_order_suborder")}">   <a href="{"orders.details?order_id={$oi.real_order_id}&an_show_order=yes"|fn_url}">#{$oi.real_order_id} (( {$oi.real_company_id|fn_get_company_name} ))</a> </td>
