{if $additinal_orders}
    {include file="common/subheader.tpl" title=__("cp_half_section") target="#cp_half_section"}
    <div id="cp_half_section" class="collapse in">
        <table width="100%" class="table table-middle">
            ...
            {foreach from=$additinal_orders item="o"}
                <tr>
                    <td>        <a href="{"orders.details?an_show_order=yes&order_id=`$o.order_id`"|fn_url}" class="underlined">{__("order")} #{$o.order_id}</a></td>
