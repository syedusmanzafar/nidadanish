...
<div class="table-responsive-wrapper longtap-selection">
    ...
    <tr>
        ...
        <th width="13%"><a class="cm-ajax" href="{"`$c_url`&sort_by=code&sort_order=`$search.sort_order_rev`"|fn_url}" data-ca-target-id={$rev}>{__("sku")}{if $search.sort_by == "code"}{$c_icon nofilter}{else}{$c_dummy nofilter}{/if}</a></th>
    ...
    {/if}
        ...
        >
            ...
            <td width="13%"><input type="text" name="products_data[{$product.product_id}][product_code]" value="{$product.product_code}" class="input-full input-hidden" /></td>
