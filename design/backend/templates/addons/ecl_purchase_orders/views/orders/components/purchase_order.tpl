...
<div style="font-family: Helvetica, Arial, sans-serif; margin-top: 10px;">{__("address")}:{$orders.package_info.origination.address}</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="1" style="direction: {$language_direction}; background-color: #808080; margin-top: 20px;">
        ...
        {foreach $ecl_order_info_print.products as $ecl_orders}
         <tr>
            ...
            <td style="font-family: Helvetica, Arial, sans-serif;padding: 5px 10px; background-color: #ffffff; text-align: left;border: 1px solid #808080;">{$ecl_orders.price}</td>
        </tr> 
        {/foreach}  
    </table>
    <div style="display: inline-block; width: 100%">
        <div style="float: right;">
        	<div style="margin-bottom: 10px;">
	            ...
	            <span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{$ecl_total_price}</span>
        	</div>
        	<div style="margin-bottom: 10px;">
	        	<span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{__("tax")}:</span>
	            <span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{$ecl_order_info_print.tax_subtotal}</span>
            </div>
            <div>
