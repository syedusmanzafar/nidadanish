...
<div style="position: relative; display: block;">
	<div style="display: inline-block">
		<img src="https://apptest.sandbox-ecom-labs.com/design/backend/media/images/Nidadanish Logo-2.png" width="200" height="100" alt="Nidadanish Logo-2" style="display: block; padding-bottom:20px;">
	</div> 
...
<div style="font-family: Helvetica, Arial, sans-serif; margin-top: 10px;">{__("address")}:{$ecl_order.company_contact}</div>
	...
	{foreach $ecl_order.orders as $ecl_products}
		{foreach $ecl_products.products  as $ecl_product}
		     <tr>
		        ...
		        <td style="font-family: Helvetica, Arial, sans-serif;padding: 5px 10px; background-color: #ffffff; text-align: center;border: 1px solid #808080;">{$ecl_product.price}</td>
		    </tr>
	   {/foreach}
	{/foreach}
	</table>
	<div style="display: inline-block; width: 100%;">
		<div style="float: right">
			<div style="margin-bottom: 10px;">
	            ...
	            <span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{$currencies.USD.symbol}&nbsp;{$total_price.$vendor_id.price}</span>
        	</div>
        	<div style="margin-bottom: 10px;">
	        	<span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{__("tax")}</span>
	            <span style="font-size: 14px; color: #444; font-family: Helvetica, Arial, sans-serif;">{$ecl_order.ecl_tax_subtotal}</span>
            </div>
            <div>
				...
				<span style="font-weight:bold;font-size: 22px; border-top: 1px solid #e8e8e8; color: #444; font-family: Helvetica, Arial, sans-serif;">&nbsp;{$currencies.USD.symbol}&nbsp;{$total_price.$vendor_id.price}</span>
			</div>
		</div>
	</div>
